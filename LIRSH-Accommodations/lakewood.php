  ...
  <div class="header">
   ...
   <div class="filter-box">
    ...
    <div class="room-list">
        ...
        $locations = array(
            "Tokyo" => "lakewood tokyo",
            "Sydney" => "lakewood sydney",
            "Paris" => "lakewood paris",
            "New York" => "lakewood new york",
            "London" => "lakewood london",
            "Dubai" => "lakewood dubai",
            "Shanghai" => "lakewood shanghai",
            "Rome" => "lakewood rome"
        );
  ...
  <script>
    ...
    function apply_filter() {
        ...
        roomItems.forEach (function(roomItem) {
          ...
          var locationMatch = (tokyo_box && hotel == "Lakewood Tokyo") || (sydney_box && hotel == "Lakewood Sydney") || (paris_box && hotel == "Lakewood Paris") || (ny_box && hotel == "Lakewood New York") || (london_box && hotel == "Lakewood London") || (dubai_box && hotel == "Lakewood Dubai") || (shanghai_box && hotel == "Lakewood Shanghai") || (rome_box && hotel == "Lakewood Rome") || (!tokyo_box && !sydney_box && !paris_box && !ny_box && !london_box && !dubai_box && !shanghai_box && !rome_box);
