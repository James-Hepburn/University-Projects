...
<body>
  <div class="header">
    ...
    <button class="header-button" onclick="use_header('Indigo')">Indigo Lodge</button>
   ...
   <div class="filter-box">
    ...
    <div class="room-list">
        ...
        $locations = array(
            "Tokyo" => "Indigo tokyo",
            "Sydney" => "Indigo sydney",
            "Paris" => "Indigo paris",
            "New York" => "Indigo new york",
            "London" => "Indigo london",
            "Dubai" => "Indigo dubai",
            "Shanghai" => "Indigo shanghai",
            "Rome" => "Indigo rome"
        );
  ...
  <script>
    ...
    function apply_filter() {
        ...
        roomItems.forEach (function(roomItem) {
          ...
          var locationMatch = (tokyo_box && hotel == "Indigo Tokyo") || (sydney_box && hotel == "Indigo Sydney") || (paris_box && hotel == "Indigo Paris") || (ny_box && hotel == "Indigo New York") || (london_box && hotel == "Indigo London") || (dubai_box && hotel == "Indigo Dubai") || (shanghai_box && hotel == "Indigo Shanghai") || (rome_box && hotel == "Indigo Rome") || (!tokyo_box && !sydney_box && !paris_box && !ny_box && !london_box && !dubai_box && !shanghai_box && !rome_box);
