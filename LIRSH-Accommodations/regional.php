...
<body>
  <div class="header">
    ...
    <button class="header-button" onclick="use_header('Regional')">Regional Lodge</button>
   ...
   <div class="filter-box">
    ...
    <div class="room-list">
        ...
        $locations = array(
            "Tokyo" => "Regional tokyo",
            "Sydney" => "Regional sydney",
            "Paris" => "Regional paris",
            "New York" => "Regional new york",
            "London" => "Regional london",
            "Dubai" => "Regional dubai",
            "Shanghai" => "Regional shanghai",
            "Rome" => "Regional rome"
        );
  ...
  <script>
    ...
    function apply_filter() {
        ...
        roomItems.forEach (function(roomItem) {
          ...
          var locationMatch = (tokyo_box && hotel == "Regional Tokyo") || (sydney_box && hotel == "Regional Sydney") || (paris_box && hotel == "Regional Paris") || (ny_box && hotel == "Regional New York") || (london_box && hotel == "Regional London") || (dubai_box && hotel == "Regional Dubai") || (shanghai_box && hotel == "Regional Shanghai") || (rome_box && hotel == "Regional Rome") || (!tokyo_box && !sydney_box && !paris_box && !ny_box && !london_box && !dubai_box && !shanghai_box && !rome_box);
